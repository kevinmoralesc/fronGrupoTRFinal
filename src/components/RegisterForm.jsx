...
const RegisterForm = ({ onRegister }) => {
  ...
  return (
    <div className="tab-content">
      <div className="flex w-full h-full bg-yellow-600 ">
            ...
            <div className="max-w-4xl mx-auto font-[sans-serif] text-[#333] p-6">
              ...
              <form onSubmit={handleSubmit(onSubmitRegister)}>
                ...
                <div className="!mt-10">
                  <button
                    type="submit"
                    className=" btn btn-primary h-50% w-full active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-yellow-700 rounded-xl text-white font-bold text-lg"
                  >
                    Registrarse
                  </button>
                </div>
